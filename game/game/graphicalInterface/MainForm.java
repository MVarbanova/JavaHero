...
public class MainForm extends javax.swing.JFrame {
	 ...
	 *
	 * @param h
	 *            becomes Current game hero
	 */
	public static void setHero(final Hero h) {
	...
	/**
	 * Sets components of Current game hero to the labels in MyHero tab
	 */
	...
	public MainForm() {
		initComponents();
		listOpponents.setModel(new DefaultListModel<>());
		listWeapons.setModel(new DefaultListModel<>());
		makeWaepons();
	...
	private void initComponents() {
		...
		// tabWeapons.add(lblWHead, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 130, 30));
		...
		// tabWeapons.add(lblHead, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, 130, 30));
		...
		// tabWeapons.add(lblWLeft, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, 130, 30));
		...
		// tabWeapons.add(lblLeft, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, 130, 30));
		...
		// tabWeapons.add(lblWRight, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 130, 30));
		...
		// tabWeapons.add(lblRight, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 280, 130, 30));
		...
		// tabWeapons.add(jScrollPane2, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(210, 40, 290, 200));
		...
		// tabWeapons.add(btnHead, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, 80, 22));
		...
		// tabWeapons.add(btnLeft, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(310, 280, 80, 22));
		...
		// tabWeapons.add(btnRight, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, 90, 22));
		...
		// tabMyHero.add(jLabel9, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 90, 30));
		...
		// tabMyHero.add(jLabel10, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 90, 30));
		...
		// tabMyHero.add(jLabel11, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(30, 240, 90, 30));
		...
		// tabMyHero.add(lblName, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 90, 30));
		...
		// tabMyHero.add(lblHealth, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(150, 150, 90, 30));
		...
		// tabMyHero.add(lblStamina, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 90, 30));
		...
		// tabMyHero.add(jLabel15, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(280, 60, 90, 30));
		...
		// tabMyHero.add(jLabel16, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(280, 150, 90, 30));
		...
		// tabMyHero.add(jLabel17, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(280, 240, 90, 30));
		...
		// tabMyHero.add(lblExperience, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(400, 60, 90, 30));
		...
		// tabMyHero.add(lblEnergy, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(400, 150, 90, 30));
		...
		// tabMyHero.add(lblMaxEnergy, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(400, 240, 90, 30));
		...
		// tabMyHero.add(btnSave, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(280, 300, 90, -1));
		...
		// tabMyHero.add(btnSearchFood, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, -1, -1));
		...
		// tabMyHero.add(lblLogout, new
		// org.netbeans.lib.awtextra.AbsoluteConstraints(500, 20, 60, 50));
	...
	private void btnSearchFoodActionPerformed() {// GEN-FIRST:event_btnSearchFoodActionPerformed
		...
		final int berry = rnd.nextInt(25) - 5;
		if (berry < 0) {
	...
	private void listOpponentsMouseClicked(final java.awt.event.MouseEvent evt) {// GEN-FIRST:event_listOpponentsMouseClicked
	...
	private void btnFightActionPerformed() {// GEN-FIRST:event_btnFightActionPerformed
		final Battle battle = new Battle(hero, heroesLibrary.get(nHeroes));
	...
	private void listWeaponsMouseClicked(final java.awt.event.MouseEvent evt) {// GEN-FIRST:event_listWeaponsMouseClicked
	...
	public static void makeOpponents() {
		...
		final int powerLeft = hero.getLeft().getPower();
		final int powerRight = hero.getRight().getPower();
		final int powerHead = hero.getHead().getPower();

		final int weightLeft = hero.getLeft().getWeight();
		final int weightRight = hero.getRight().getWeight();
		final int weightHead = hero.getHead().getWeight();

		final int stamina = hero.getStamina();

		final int energy = hero.getEnergy();

		heroesLibrary.add(
				new Hero("Appius", 23.4, new Item("Optimus", rnd.nextInt(powerLeft) + 1, rnd.nextInt(weightLeft) + 1),
						new Item("AK47", rnd.nextInt(powerRight) + 1, rnd.nextInt(weightRight) + 1),
						new Item("Bradva", rnd.nextInt(powerHead) + 1, rnd.nextInt(weightHead) + 1), 100,
						rnd.nextInt(stamina), rnd.nextInt(energy), 100));
		modelHeros.addElement("Appius");

		heroesLibrary
				.add(new Hero("Decimus", 12, new Item("Alfa", rnd.nextInt(powerLeft) + 1, rnd.nextInt(weightLeft) + 1),
						new Item("Beta", rnd.nextInt(powerRight) + 1, rnd.nextInt(weightRight) + 1),
						new Item("Gama", rnd.nextInt(powerHead) + 1, rnd.nextInt(weightHead) + 1), 100,
						rnd.nextInt(stamina), rnd.nextInt(energy), 100));
		modelHeros.addElement("Decimus");

		heroesLibrary
				.add(new Hero("Gaius", 245, new Item("Tita", rnd.nextInt(powerLeft) + 1, rnd.nextInt(weightLeft) + 1),
						new Item("Epsilon", rnd.nextInt(powerRight) + 1, rnd.nextInt(weightRight) + 1),
						new Item("Mu", rnd.nextInt(powerHead) + 1, rnd.nextInt(weightHead) + 1), 100,
						rnd.nextInt(stamina), rnd.nextInt(energy), 100));
		modelHeros.addElement("Gaius");

		heroesLibrary.add(new Hero("Mamercus", hero.getExperience(),
				new Item("Delta", rnd.nextInt(powerLeft + 10) + 1, rnd.nextInt(weightLeft + 10) + 1),
				new Item("MP4", rnd.nextInt(powerRight + 10) + 1, rnd.nextInt(weightRight + 10) + 1),
				new Item("Kirka", rnd.nextInt(powerHead + 10) + 1, rnd.nextInt(weightHead + 10) + 1), 100, stamina,
				energy, hero.getMaxEnergy()));
		modelHeros.addElement("Mamercus");

		heroesLibrary.add(
				new Hero("Quintus", 43, new Item("Lopata", rnd.nextInt(10) + powerLeft, rnd.nextInt(10) + weightRight),
						new Item("Joker", rnd.nextInt(10) + powerRight, rnd.nextInt(10) + weightRight),
						new Item("Zvezdichka", rnd.nextInt(10) + powerHead, rnd.nextInt(10) + weightHead), 80,
						rnd.nextInt(10) + stamina, rnd.nextInt(10) + energy, 100));
		modelHeros.addElement("Quintus");

		heroesLibrary.add(
				new Hero("Titus", 65.4, new Item("Piron", rnd.nextInt(20) + powerLeft, rnd.nextInt(20) + weightLeft),
						new Item("Chuk", rnd.nextInt(20) + powerRight, rnd.nextInt(20) + weightRight),
						new Item("Shpoka", rnd.nextInt(20) + powerHead, rnd.nextInt(20) + weightHead), 90, stamina,
						energy, 100));
